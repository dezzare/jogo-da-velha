...
function checaVencedor() {
  ...
  if (checaSequencia( quadrado1, quadrado2, quadrado3)) {
    mudaCorQuadrado(quadrado1, quadrado2, quadradro3);
...
function mudarVencedor(quadrado) {
  ...
  let vencedorEscondido = document.getElementById('vencedorId');
  vencedorEscondido.classList.remove("escondido");

  let jogadorEscondido = document.getElementById('jogadorId');
  jogadorId.classList.add("escondido");
...
function reiniciar() {
  ...
  let vencedorId = document.getElementById('vencedorId')
  let jogadorId = document.getElementById('jogadorId')
  vencedorId.classList.add('escondido');
  jogadorId.classList.remove('escondido');
